...
- O link de redefinição de senha enviado por e-mail só pode ser usado uma única vez. Após ser utilizado ou expirado, deve-se exibir uma mensagem informando que o link é inválido ou expirado, e orientar o usuário a solicitar um novo link.
