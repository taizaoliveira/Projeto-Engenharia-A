...
| Critérios / Soluções        |             Mais Saúde Fortaleza                | e-saudeSP       | Google Maps       | Nossa Solução                   |
|-----------------------------|----------------------------------|----------------------------------|----------------------------------|----------------------------------|
...
| **Tecnologia utilizada**    | Mobile                           | Mobile, Web, IA e GPS            | Coleta de Dados, APIs, SDKs e IA                           |       Thunkable, Firebase, geolocalização, Leitores de Tela, dados locais                            |
| **Público-alvo**            | População de Fortaleza | População de São Paulo         |Usuários finais, Empresas, Desenvolvedores e Anunciantes                                  |    População de Itacoatiara                              |
| **Pontos fortes**           |Agendamento e confirmação de consultas com envio de lembretes, visualização do histórico de atendimentos e vacinas, integração com o Google Maps para localização dos serviços| Tecnologia avançada; Apoio à gestão pública; Facilidade de uso (Responsividade); | Cobertura global; Integração com Ecossistema Google; Precisão e Inovação; Monetização Flexível e Ferramentas para Desenvolvedores                 |   Foco territorial e em saúde pública; Interface acessível; Uso de tecnologias gratuitas; Conectividade com UBS locais; Suporte comunitário                                |
| **Pontos fracos / limitações**|Apesar das funcionalidades relevantes, o aplicativo Mais Saúde Fortaleza apresenta falhas que comprometem a usabilidade. problemas técnicos e de estabilidade; | Problemas de usabilidade e acessibilidade; Problemas técnicos e de estabilidade; Dependência da infraestrutura e conectividade | Dependência de Conexão à Internet; Privacidade e Coleta de Dados; Custos de API; Concorrência e Precisão em Áreas Remotas               |  Dependência de Conexão à Internet; Privacidade e Coleta de Dados; Custos de API; Concorrência e Precisão em Áreas Remotas | Dependência de conectividade; Sustentabilidade do projeto a longo prazo; Manutenção comunitária; Limitações de escalabilidade sem apoio institucional                   |
